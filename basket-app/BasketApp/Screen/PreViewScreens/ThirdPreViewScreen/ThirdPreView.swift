...
class ThirdPreView: UIView{
    
    var thirdPreViewImage: UIImageView = {
        var image = UIImageView()
        image.image = UIImage(named: "thirdPreView")
    ...
    var textLabel: UILabel = {
        var label = UILabel()
        label.text = "Attend matches and get achievements"
    ...
    func setupViews(){
        self.addSubview(thirdPreViewImage)
    ...
    func setupConstraints(){
        ...
        stackView.snp.makeConstraints { make in
            ...
            make.top.equalTo(thirdPreViewImage.snp.bottom)
        }
    }
}
