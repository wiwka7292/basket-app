...
class SecondPreView: UIView{
    
    var secondPreViewImage: UIImageView = {
        var image = UIImageView()
        image.image = UIImage(named: "secondPreView")
    ...
    var navigButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(SecondPreViewController.nextButtonTapped), for: .touchUpInside)
        return button
    }()
    
    var textLabel: UILabel = {
        var label = UILabel()
        label.text = "Compare teams head to head"
    ...
    func setupViews(){
        self.addSubview(secondPreViewImage)
    ...
    func setupConstraints(){
        ...
        stackView.snp.makeConstraints { make in
            ...
            make.top.equalTo(secondPreViewImage.snp.bottom)
        }
    }
}
